...
(function () {
	...
	if (URL_LOGGING)
		app.use((req, res, next) => {
			if (!req.url.endsWith('VerifyRealMoneyPurchase?profileId=common_core&rvn=1') && !req.url.endsWith('Sentimos que tengas este error, estamos trabajando para impedir errores como este en el futuro.')){
				console.log(req.url)
			}
			next()
		})
	...
	app.listen(process.env.PORT || 8080, () => {
		console.log(`ONIZUKAFN Hibrido v${version} Conectado al puerto ${777}!`);
	});
